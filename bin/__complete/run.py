#!/usr/bin/env python3
"""
ops __complete [prior words...] — the brain behind zsh tab-completion (Tier-1 ergonomics).
...
hardcoded subaction tables here anymore (ops.json/3): the grammar lives in cmd.json, so completion
can never drift from the real surface, and `ops complete --json` shares this exact brain. Hidden from
